    ...
    return (
        <Box maxW="1020px" mx={{ base: '0', xl: 'auto' }} boxShadow='base' bg="$White" position="absolute" top="7rem" left={{ base: '4', sm: '4', md: '8', xl: '0' }} right={{ base: '4', sm: '4', md: '8', xl: '0' }} zIndex="2" borderRadius="5px">
            ...
            <form onSubmit={handleFormSubmit}>
                <Flex flexDirection={{ base: 'column', md: 'row' }} justifyContent="space-between" alignItems="flex-start" flexWrap={{ base: "nowrap", md: "wrap" }} pt="1rem" >
                    <Box flex="1" w={{ base: "100%"}} px={{ base: '1rem', md: '2rem' }} pb={{ base: '2rem', md: '1rem' }} borderBottom={{ base: '1px solid', md: 'none' }} borderRight={{ base: 'none', md: '1px solid' }} borderColor={{ base: '$Cloud', md: '$Cloud' }}  width={{ base: "100%", md: "50%" }}>
                        <Heading as="h2" size="lg" fontSize={{ base: 'mh2SubHeader', md: 'h2SubHeader' }} lineHeight={{ base: 'mh2SubHeader', md: 'h2SubHeader' }}>Warehouse Details
                        </Heading>

                        <FormControl isInvalid={formErrors && formErrors.includes("Warehouse Name is required")} name="warehouse_name" id="warehouse_name" mt={4}>
                        ...
                        <FormControl isInvalid={formErrors && formErrors.includes("Street Address is required")} name="address" id="address" mt={4}>
                            <FormLabel as="h3" fontSize={{ base: 'mh3Labels', md: 'h3Labels' }} lineHeight={{ base: 'mh3Labels', md: 'h3Labels' }}>
                                Street Address
                            </FormLabel>
                        ...
                        <FormControl isInvalid={formErrors && formErrors.includes("City is required")} name="city" id="city" mt={4}>
                            <FormLabel as="h3" fontSize={{ base: 'mh3Labels', md: 'h3Labels' }} lineHeight={{ base: 'mh3Labels', md: 'h3Labels' }}>
                                City
                            </FormLabel>
                        ...
                        <FormControl isInvalid={formErrors && formErrors.includes("Country is required")} name="country" id="country" mt={4}>
                            <FormLabel as="h3" fontSize={{ base: 'mh3Labels', md: 'h3Labels' }} lineHeight={{ base: 'mh3Labels', md: 'h3Labels' }}>
                                Country
                            </FormLabel>
                    ...
                    <Box flex="1" w="100%" px={{ base: '1rem', md: '2rem' }} pt={{ base: "2rem", md: "0" }} width={{ base: "100%", md: "50%" }}>
                        <Heading as="h2" size="lg" fontSize={{ base: 'mh2SubHeader', sm: 'mh2SubHeader', md: 'h2SubHeader' }} lineHeight={{ base: 'mh2SubHeader', sm: 'mh2SubHeader', md: 'h2SubHeader' }}>Contact Details
                        </Heading>
                        
                        <FormControl isInvalid={formErrors && formErrors.includes("Contact Name is required")} name="contact_name" id="contact_name" mt={4}>
                            <FormLabel as="h3" fontSize={{ base: 'mh3Labels', md: 'h3Labels' }} lineHeight={{ base: 'mh3Labels', md: 'h3Labels' }}>
                                Contact Name
                            </FormLabel>
                        ...
                        <FormControl isInvalid={formErrors && formErrors.includes("Contact Position is required")} name="contact_position" id="contact_position" mt={4}>
                            <FormLabel as="h3" fontSize={{ base: 'mh3Labels', md: 'h3Labels' }} lineHeight={{ base: 'mh3Labels', md: 'h3Labels' }}>
                                Position
                            </FormLabel>
                        ...
                        <FormControl isInvalid={formErrors && formErrors.includes("Invalid phone number")} name="contact_phone" id="contact_phone" mt={4}>
                            <FormLabel as="h3" fontSize={{ base: 'mh3Labels', md: 'h3Labels' }} lineHeight={{ base: 'mh3Labels', md: 'h3Labels' }}>
                                Phone Number
                            </FormLabel>
                            ...
                            <FormErrorMessage>
                                <Error mr="1"/> {formErrors && formErrors.includes("Invalid phone number") && "Invalid phone number"}
                            </FormErrorMessage>
                        </FormControl>
